Copyright (C) 2012-2014 GOVCERT.LU
...
This project uses the following software which is licensed as:

Twitter Bootstrap CSS/JS framework 
under the Apache v2.0 license.
The license is included in the docs/licenses folder.
...
The license is included in the docs/licenses folder.
URL: https://github.com/mgcrea/angular-strap
...
The license is included in the docs/licenses folder.
URL: http://caligatio.github.com/jsSHA
...
under the The MIT License
The license is included in the docs/licenses folder.
URL: https://github.com/artch/angular-route-segment

angular-loading-bar
Copyright (c) 2014 Wes Cruver
under the The MIT License
The license is included in the docs/licenses folder.
URL: https://github.com/chieffancypants/angular-loading-bar
