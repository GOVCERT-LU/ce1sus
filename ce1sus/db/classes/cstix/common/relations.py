...
_REL_RELATEDOBSERVABLE_CONFIDENCE = Table('rel_relatedobservable_confidence', getattr(Base, 'metadata'),
                                          ...
                                          Column('relatedobservable_id', BigIntegerType, ForeignKey('relatedobservables.relatedobservable_id', ondelete='cascade', onupdate='cascade'), index=True, primary_key=True, nullable=False),
...
_REL_RELATEDEXPLOITTARGET_CONFIDENCE = Table('rel_relatedexploittarget_confidence', getattr(Base, 'metadata'),
                                             ...
                                             Column('relatedexploittarget_id', BigIntegerType, ForeignKey('relatedexploittargets.relatedexploittarget_id', ondelete='cascade', onupdate='cascade'), index=True, primary_key=True, nullable=False),
                                             Column('confidence_id', BigIntegerType, ForeignKey('confidences.confidence_id', ondelete='cascade', onupdate='cascade'), nullable=False, primary_key=True, index=True)
                                             )

_REL_RELATEDPACKAGEREF_CONFIDENCE = Table('rel_relatedpackageref_confidence', getattr(Base, 'metadata'),

                                          Column('relatedpackageref_id', BigIntegerType, ForeignKey('relatedpackagerefs.relatedpackageref_id', ondelete='cascade', onupdate='cascade'), index=True, primary_key=True, nullable=False),
                                          Column('confidence_id', BigIntegerType, ForeignKey('confidences.confidence_id', ondelete='cascade', onupdate='cascade'), nullable=False, primary_key=True, index=True)
                                          )

_REL_RELATEDPACKAGE_CONFIDENCE = Table('rel_relatedpackage_confidence', getattr(Base, 'metadata'),

                                       Column('relatedpackage_id', BigIntegerType, ForeignKey('relatedpackages.relatedpackage_id', ondelete='cascade', onupdate='cascade'), index=True, primary_key=True, nullable=False),
                                       Column('confidence_id', BigIntegerType, ForeignKey('confidences.confidence_id', ondelete='cascade', onupdate='cascade'), nullable=False, primary_key=True, index=True)
                                       )

_REL_RELATEDCAMPAIGN_CONFIDENCE = Table('rel_relatedcampaign_confidence', getattr(Base, 'metadata'),

                                        Column('relatedcampaign_id', BigIntegerType, ForeignKey('relatedcampaigns.relatedcampaign_id', ondelete='cascade', onupdate='cascade'), index=True, primary_key=True, nullable=False),
                                        Column('confidence_id', BigIntegerType, ForeignKey('confidences.confidence_id', ondelete='cascade', onupdate='cascade'), nullable=False, primary_key=True, index=True)
                                        )

_REL_RELATEDCOA_CONFIDENCE = Table('rel_relatedcoa_confidence', getattr(Base, 'metadata'),

                                        Column('relatedcoa_id', BigIntegerType, ForeignKey('relatedcoas.relatedcoa_id', ondelete='cascade', onupdate='cascade'), index=True, primary_key=True, nullable=False),
                                        Column('confidence_id', BigIntegerType, ForeignKey('confidences.confidence_id', ondelete='cascade', onupdate='cascade'), nullable=False, primary_key=True, index=True)
                                        )

_REL_RELATEDIDENTITY_CONFIDENCE = Table('rel_relatedidentity_confidence', getattr(Base, 'metadata'),

                                        Column('relatedidentity_id', BigIntegerType, ForeignKey('relatedidentitys.relatedidentity_id', ondelete='cascade', onupdate='cascade'), index=True, primary_key=True, nullable=False),
                                        Column('confidence_id', BigIntegerType, ForeignKey('confidences.confidence_id', ondelete='cascade', onupdate='cascade'), nullable=False, primary_key=True, index=True)
                                        )

_REL_RELATEDINDICATOR_CONFIDENCE = Table('rel_relatedindicator_confidence', getattr(Base, 'metadata'),

                                         Column('relatedindicator_id', BigIntegerType, ForeignKey('relatedindicators.relatedindicator_id', ondelete='cascade', onupdate='cascade'), index=True, primary_key=True, nullable=False),
                                         Column('confidence_id', BigIntegerType, ForeignKey('confidences.confidence_id', ondelete='cascade', onupdate='cascade'), nullable=False, primary_key=True, index=True)
                                         )

_REL_RELATEDINCIDENT_CONFIDENCE = Table('rel_relatedincident_confidence', getattr(Base, 'metadata'),

                                         Column('relatedincident_id', BigIntegerType, ForeignKey('relatedincidents.relatedincident_id', ondelete='cascade', onupdate='cascade'), index=True, primary_key=True, nullable=False),
                                         Column('confidence_id', BigIntegerType, ForeignKey('confidences.confidence_id', ondelete='cascade', onupdate='cascade'), nullable=False, primary_key=True, index=True)
                                         )

_REL_RELATEDTHREATACTOR_CONFIDENCE = Table('rel_relatedthreatactor_confidence', getattr(Base, 'metadata'),

                                           Column('relatedthreatactor_id', BigIntegerType, ForeignKey('relatedthreatactors.relatedthreatactor_id', ondelete='cascade', onupdate='cascade'), index=True, primary_key=True, nullable=False),
                                           Column('confidence_id', BigIntegerType, ForeignKey('confidences.confidence_id', ondelete='cascade', onupdate='cascade'), nullable=False, primary_key=True, index=True)
                                           )

_REL_RELATEDTTP_CONFIDENCE = Table('rel_relatedttp_confidence', getattr(Base, 'metadata'),

                                   Column('relatedttp_id', BigIntegerType, ForeignKey('relatedttps.relatedttp_id', ondelete='cascade', onupdate='cascade'), index=True, primary_key=True, nullable=False),
                                   Column('confidence_id', BigIntegerType, ForeignKey('confidences.confidence_id', ondelete='cascade', onupdate='cascade'), nullable=False, primary_key=True, index=True)
                                   )
