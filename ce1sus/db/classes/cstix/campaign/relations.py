...
_REL_CAMPAIGN_HANDLING = Table('rel_campaign_handling', getattr(Base, 'metadata'),
                                ...
                                Column('campaign_id', BigIntegerType, ForeignKey('campaigns.campaign_id', ondelete='cascade', onupdate='cascade'), index=True, primary_key=True, nullable=False),
                                Column('markingspecification_id', BigIntegerType, ForeignKey('markingspecifications.markingspecification_id', ondelete='cascade', onupdate='cascade'), primary_key=True, nullable=False, index=True)
                                )
...
_REL_CAMPAIGN_RELATED_PACKAGES = Table('rel_campaign_rel_package', getattr(Base, 'metadata'),
                                       Column('campaign_id', BigIntegerType, ForeignKey('campaigns.campaign_id', ondelete='cascade', onupdate='cascade'), index=True, primary_key=True, nullable=False),
                                       Column('relatedpackageref_id', BigIntegerType, ForeignKey('relatedpackagerefs.relatedpackageref_id', ondelete='cascade', onupdate='cascade'), primary_key=True, nullable=False, index=True)
                                       )

_REL_CAMPAIGN_RELATED_THREATACTOR = Table('rel_campaign_rel_threatactor', getattr(Base, 'metadata'),

                                          Column('campaign_id', BigIntegerType, ForeignKey('campaigns.campaign_id', ondelete='cascade', onupdate='cascade'), index=True, primary_key=True, nullable=False),
                                          Column('relatedthreatactor_id', BigIntegerType, ForeignKey('relatedthreatactors.relatedthreatactor_id', ondelete='cascade', onupdate='cascade'), primary_key=True, nullable=False, index=True)
                                          )
...
_REL_CAMPAIGN_CONFIDENCE = Table('rel_campaign_confidence', getattr(Base, 'metadata'),
                                        ...
                                        Column('campaign_id', BigIntegerType, ForeignKey('campaigns.campaign_id', ondelete='cascade', onupdate='cascade'), index=True, primary_key=True, nullable=False),
                                        Column('confidence_id', BigIntegerType, ForeignKey('confidences.confidence_id', ondelete='cascade', onupdate='cascade'), index=True, primary_key=True, nullable=False,)
                                        )
