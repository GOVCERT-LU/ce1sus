...
MISP_MAP = {            
            ...
            'Payload delivery/md5':'cybox-Observable-File-md5',
            'Payload delivery/sha1':'cybox-Observable-File-sha1',
            'Payload delivery/sha256':'cybox-Observable-File-sha256',
            'Payload delivery/filename':'cybox-Observable-File-File_Name',
            'Payload delivery/filename|md5':'cybox-Observable-File-md5',
            'Payload delivery/filename|sha1':'cybox-Observable-File-sha1',
            'Payload delivery/filename|sha256':'cybox-Observable-File-sha256',
            ...
            'Artifacts dropped/md5':'cybox-Observable-File-md5',
            'Artifacts dropped/sha1':'cybox-Observable-File-sha1',
            'Artifacts dropped/sha256':'cybox-Observable-File-sha256',
            'Artifacts dropped/filename':'cybox-Observable-File-File_Name',
            'Artifacts dropped/filename|md5':'cybox-Observable-File-md5',
            'Artifacts dropped/filename|sha1':'cybox-Observable-File-sha1',
            'Artifacts dropped/filename|sha256':'cybox-Observable-File-sha256',
            'Artifacts dropped/regkey':'cybox-Observable-WinRegistryKey',
            'Artifacts dropped/regkey|value':'cybox-Observable-WinRegistryKey-WindowsRegistryKey_RegistryValue_Data',
            ...
            'Payload installation/md5':'cybox-Observable-File-md5',
            'Payload installation/sha1':'cybox-Observable-File-sha1',
            'Payload installation/sha256':'cybox-Observable-File-sha256',
            'Payload installation/filename':'cybox-Observable-File-File_Name',
            'Payload installation/filename|md5':'cybox-Observable-File-md5',
            'Payload installation/filename|sha1':'cybox-Observable-File-sha1',
            'Payload installation/filename|sha256':'cybox-Observable-File-sha256',
            ...
            'Persistence mechanism/regkey|value':'cybox-Observable-WinRegistryKey-WindowsRegistryKey_RegistryValue_Data',
            ...
            'External analysis/md5':'cybox-Observable-File-md5',
            'External analysis/sha1':'cybox-Observable-File-sha1',
            'External analysis/sha256':'cybox-Observable-File-sha256',
            'External analysis/filename':'cybox-Observable-File',
            'External analysis/filename|md5':'cybox-Observable-File-md5',
            'External analysis/filename|sha1':'cybox-Observable-File-sha1',
            'External analysis/filename|sha256':'cybox-Observable-File-sha256',
            ...
            'External analysis/regkey|value':'cybox-Observable-WinRegistryKey-WindowsRegistryKey_RegistryValue_Data',
