...
class Testhash(unittest.TestCase):
  ...
  def testHashes(self):
    ...
    assert hasher.hashSHA1('Test') == '640ab2bae07bedc4c163f679a746f7ab7fb5d1fa'
    assert hasher.hashSHA256('Test') == ('532eaabd9574880dbf76b9b8cc00832c20a6e'
                                       + 'c113d682299550d7a6e0f345e25')
    assert hasher.hashSHA384('Test') == ('7b8f4654076b80eb963911f19cfad1aaf4285'
