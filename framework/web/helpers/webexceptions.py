...
import framework.helpers.string as stringHelper
...
class ErrorHandler(object):
  ...
  def blueScreen(title='500', error='DEFAULT', text='DEFAULT MESSAGE'):
    ...
    """
    return MakoHandler.getInstance().renderTemplate("errors/blueScreen.html",
  ...
  def commodore(title='500', error='DEFAULT', text='DEFAULT MESSAGE'):
    ...
    :returns: generated HTML
    """
    return MakoHandler.getInstance().renderTemplate("errors/errorC64.html",
                                                    title=title, error=error)
